...
@{
    ...
    RequiredModules = @(@{ModuleName = 'PSWriteWord'; GUID = '6314c78a-d011-4489-b462-91b05ec6a5c4'; ModuleVersion = '1.0.0'; }, 
        ...
        @{ModuleName = 'PSWinDocumentation.AD'; GUID = 'a46f9775-04d2-4423-9631-01cfda42b95d'; ModuleVersion = '0.1.5'; }, 
        @{ModuleName = 'PSWinDocumentation.AWS'; GUID = 'b3c23202-740d-4f7b-a9d7-bd87063381cc'; ModuleVersion = '0.0.3'; }, 
        @{ModuleName = 'PSWinDocumentation.O365'; GUID = '71ea1419-d950-444b-83c9-c579de74962a'; ModuleVersion = '0.0.1'; })
